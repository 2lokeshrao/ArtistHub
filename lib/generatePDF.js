...
/** * Magic Function: Google Drive link ko Direct Image link mein badalta hai 
 * Taaki PDF mein images blank na aayein.
 */
...
async function loadImageAsBase64(url) {
  // Yahan humne transform logic jodd diya hai
  const finalUrl = transformDriveLink(url);
